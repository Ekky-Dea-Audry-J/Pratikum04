...
import { Box, Image, Text, ScrollView, Alert } from "native-base";
    ...
    <ScrollView>
      ...
      <Box p="15px">
        ...
        <Text>
          ...
          sebutan baru-baru ini yang kerap dilemparkan pada mereka yang lahir
          pada tahun 2000-an, generasi strawberi. Pelabelan ini dikarenakan
          generasi sebelumnya (Boomers dan X) menilai generasi muda lunak dan
          mudah terluka seperti buah strawberi.
        </Text>
        <Separator height={10} />
        <Text>
